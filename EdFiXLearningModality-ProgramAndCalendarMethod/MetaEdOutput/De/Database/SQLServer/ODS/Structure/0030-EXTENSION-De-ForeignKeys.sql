...
ALTER TABLE [de].[MedicalOfficeVisit] WITH CHECK ADD CONSTRAINT [FK_MedicalOfficeVisit_Person] FOREIGN KEY ([PersonId], [SourceSystemDescriptorId])
...
ALTER TABLE [de].[MedicalOfficeVisitContactType] WITH CHECK ADD CONSTRAINT [FK_MedicalOfficeVisitContactType_MedicalOfficeVisit] FOREIGN KEY ([OfficeInDate], [PersonId], [SourceSystemDescriptorId])
...
ALTER TABLE [de].[MedicalOfficeVisitMedicalDisposition] WITH CHECK ADD CONSTRAINT [FK_MedicalOfficeVisitMedicalDisposition_MedicalOfficeVisit] FOREIGN KEY ([OfficeInDate], [PersonId], [SourceSystemDescriptorId])
REFERENCES [de].[MedicalOfficeVisit] ([OfficeInDate], [PersonId], [SourceSystemDescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [de].[MedicalOfficeVisitMedicalTreatmentCode] WITH CHECK ADD CONSTRAINT [FK_MedicalOfficeVisitMedicalTreatmentCode_MedicalOfficeVisit] FOREIGN KEY ([OfficeInDate], [PersonId], [SourceSystemDescriptorId])
REFERENCES [de].[MedicalOfficeVisit] ([OfficeInDate], [PersonId], [SourceSystemDescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [de].[MedicalOfficeVisitMedicalVisitReason] WITH CHECK ADD CONSTRAINT [FK_MedicalOfficeVisitMedicalVisitReason_MedicalOfficeVisit] FOREIGN KEY ([OfficeInDate], [PersonId], [SourceSystemDescriptorId])
REFERENCES [de].[MedicalOfficeVisit] ([OfficeInDate], [PersonId], [SourceSystemDescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [de].[MedicalReferralFollowUp] WITH CHECK ADD CONSTRAINT [FK_MedicalReferralFollowUp_Person] FOREIGN KEY ([PersonId], [SourceSystemDescriptorId])
REFERENCES [edfi].[Person] ([PersonId], [SourceSystemDescriptorId])
GO
...
ALTER TABLE [de].[MedicalScreening] WITH CHECK ADD CONSTRAINT [FK_MedicalScreening_Person] FOREIGN KEY ([PersonId], [SourceSystemDescriptorId])
REFERENCES [edfi].[Person] ([PersonId], [SourceSystemDescriptorId])
GO
...
ALTER TABLE [de].[NonStudent] WITH CHECK ADD CONSTRAINT [FK_NonStudent_Person] FOREIGN KEY ([PersonId], [SourceSystemDescriptorId])
REFERENCES [edfi].[Person] ([PersonId], [SourceSystemDescriptorId])
GO
...
ALTER TABLE [de].[ParentAddressExtension] WITH CHECK ADD CONSTRAINT [FK_ParentAddressExtension_ParentAddress] FOREIGN KEY ([AddressTypeDescriptorId], [City], [ParentUSI], [PostalCode], [StateAbbreviationDescriptorId], [StreetNumberName])
...
ALTER TABLE [de].[PersonDisciplineAction] WITH CHECK ADD CONSTRAINT [FK_PersonDisciplineAction_Person] FOREIGN KEY ([PersonId], [SourceSystemDescriptorId])
REFERENCES [edfi].[Person] ([PersonId], [SourceSystemDescriptorId])
GO
...
ALTER TABLE [de].[PersonDisciplineActionDiscipline] WITH CHECK ADD CONSTRAINT [FK_PersonDisciplineActionDiscipline_PersonDisciplineAction] FOREIGN KEY ([ActionIdentifier], [ActionStartDate], [IncidentIdentifier], [PersonId], [SchoolId], [SourceSystemDescriptorId])
...
ALTER TABLE [de].[PersonDisciplineActionDisciplineDisposition] WITH CHECK ADD CONSTRAINT [FK_PersonDisciplineActionDisciplineDisposition_PersonDisciplineAction] FOREIGN KEY ([ActionIdentifier], [ActionStartDate], [IncidentIdentifier], [PersonId], [SchoolId], [SourceSystemDescriptorId])
REFERENCES [de].[PersonDisciplineAction] ([ActionIdentifier], [ActionStartDate], [IncidentIdentifier], [PersonId], [SchoolId], [SourceSystemDescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [de].[PersonDisciplineIncidentAssociation] WITH CHECK ADD CONSTRAINT [FK_PersonDisciplineIncidentAssociation_Person] FOREIGN KEY ([PersonId], [SourceSystemDescriptorId])
REFERENCES [edfi].[Person] ([PersonId], [SourceSystemDescriptorId])
GO
...
ALTER TABLE [de].[PersonDisciplineIncidentAssociationVictimInjury] WITH CHECK ADD CONSTRAINT [FK_PersonDisciplineIncidentAssociationVictimInjury_PersonDisciplineIncidentAssociation] FOREIGN KEY ([IncidentIdentifier], [ParticipantNumber], [ParticipationCodeDescriptorId], [PersonId], [SchoolId], [SourceSystemDescriptorId])
REFERENCES [de].[PersonDisciplineIncidentAssociation] ([IncidentIdentifier], [ParticipantNumber], [ParticipationCodeDescriptorId], [PersonId], [SchoolId], [SourceSystemDescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [de].[PersonImmunization] WITH CHECK ADD CONSTRAINT [FK_PersonImmunization_Person] FOREIGN KEY ([PersonId], [SourceSystemDescriptorId])
REFERENCES [edfi].[Person] ([PersonId], [SourceSystemDescriptorId])
GO
...
ALTER TABLE [de].[PersonMedicationBoxAssociation] WITH CHECK ADD CONSTRAINT [FK_PersonMedicationBoxAssociation_Person] FOREIGN KEY ([PersonId], [SourceSystemDescriptorId])
REFERENCES [edfi].[Person] ([PersonId], [SourceSystemDescriptorId])
GO
...
ALTER TABLE [de].[PersonMedicationBoxAssociationIssue] WITH CHECK ADD CONSTRAINT [FK_PersonMedicationBoxAssociationIssue_PersonMedicationBoxAssociation] FOREIGN KEY ([LocalEducationAgencyId], [MedicationBoxId], [PersonId], [SourceSystemDescriptorId])
...
ALTER TABLE [de].[RestraintSeclusion] WITH CHECK ADD CONSTRAINT [FK_RestraintSeclusion_DeescalationTechniqueDescriptor] FOREIGN KEY ([DeescalationTechniqueDescriptorId])
REFERENCES [de].[DeescalationTechniqueDescriptor] ([DeescalationTechniqueDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_RestraintSeclusion_DeescalationTechniqueDescriptor]
...
ALTER TABLE [de].[RestraintSeclusion] WITH CHECK ADD CONSTRAINT [FK_RestraintSeclusion_NonViolentTechniqueDescriptor] FOREIGN KEY ([NonViolentTechniqueDescriptorId])
REFERENCES [de].[NonViolentTechniqueDescriptor] ([NonViolentTechniqueDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_RestraintSeclusion_NonViolentTechniqueDescriptor]
